...
async function seed() {
  ...
  const users = await Promise.all([
    ...
    User.create({
      ...
      username: "murphy",
      password: "123",
      email: "murphyy@tripwisetest.com",
    ...
    User.create({
      ...
      username: "diego",
      password: "pw15",
      email: "dIvories@tripwisetest.com",
    ...
    User.create({
      ...
      username: "neil",
      password: "pw45",
      email: "ngoldman@tripwisetest.com",
    ...
    User.create({
      ...
      username: "delia",
      password: "pw95",
      email: "dharley@tripwisetest.com",
    ...
    User.create({
      ...
      username: "elise",
      password: "pw35",
      email: "ebenjamin@tripwisetest.com",
    ...
    User.create({
      ...
      username: "sara2",
      password: "pwsara",
      email: "sara@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "connor",
      password: "pwconnor",
      email: "connor@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "jen",
      password: "pwjen",
      email: "jen@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "bradley",
      password: "pwbradley",
      email: "bradley@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "darian",
      password: "pwdarian",
      email: "darian@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "gemma",
      password: "pwgemma",
      email: "gemma@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "sue2",
      password: "pwsue",
      email: "sue@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "bella",
      password: "pwbella",
      email: "bella@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "ben",
      password: "pwben",
      email: "ben@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "devon",
      password: "pwdevon",
      email: "devon@tripwisetestdemo.com",
    ...
    User.create({
      ...
      username: "mariah",
      password: "pwmariah",
      email: "mariah@tripwisetestdemo.com",
  ...
  const murphy = await getUIDByEmail("murphyy@tripwisetest.com");
  const cody = await getUIDByEmail("cody@tripwisetest.com");
  const collin = await getUIDByEmail("collin@tripwisetest.com");
  const kirk = await getUIDByEmail("kirk@tripwisetest.com");
  const yuri = await getUIDByEmail("yuri@tripwisetest.com");
  const lizzy = await getUIDByEmail("lizzy@tripwisetest.com");
  const ashley = await getUIDByEmail("ashley@tripwisetest.com");
  const neil = await getUIDByEmail("ngoldman@tripwisetest.com");
  const diego = await getUIDByEmail("dIvories@tripwisetest.com");
  const jacob = await getUIDByEmail("jacob@tripwisetest.com");
  const tim = await getUIDByEmail("tsmith@tripwisetest.com");
  const sara = await getUIDByEmail("sfoley@tripwisetest.com");
  const jessie = await getUIDByEmail("jcanon@tripwisetest.com");
  const delia = await getUIDByEmail("dharley@tripwisetest.com");
  const elise = await getUIDByEmail("ebenjamin@tripwisetest.com");

  // DEMO
  const sarap = await getUIDByEmail("sara@tripwisetestdemo.com");
  const connor = await getUIDByEmail("connor@tripwisetestdemo.com");
  const jen = await getUIDByEmail("jen@tripwisetestdemo.com");
  const bradley = await getUIDByEmail("bradley@tripwisetestdemo.com");
  const darian = await getUIDByEmail("darian@tripwisetestdemo.com");
  const gemma = await getUIDByEmail("gemma@tripwisetestdemo.com");
  const sue = await getUIDByEmail("sue@tripwisetestdemo.com");
  const bella = await getUIDByEmail("bella@tripwisetestdemo.com");
  const ben = await getUIDByEmail("ben@tripwisetestdemo.com");
  const devon = await getUIDByEmail("devon@tripwisetestdemo.com");
  const mariah = await getUIDByEmail("mariah@tripwisetestdemo.com");
